...
fileInfo = Sys.glob(paste(globalVar$inpConfig, "Big_Data_For_Input_ASOS_2011-2019_QC.inp", sep = "/"))
...
# 기상 관측소 정보 읽기
#************************************************************************
fileInfo = Sys.glob(paste(globalVar$inpConfig, "Station_Information_20190714.info", sep = "/"))
