...
subroutine TestLoop()
    ...
    real(8), dimension(10) :: D_mat, R_mat, dimSumR, dimMeanR, dimValD, initDimDel, initDimR
...
!    real, dimension(:), allocatable :: dimAvg,z
    ...
    open(10, file="./FORTRAN/input-dimD.dat")
    do i = 1, 10
       read(10, *) initDimDel(i)
    enddo
    close(10)
    
    open(11, file="./FORTRAN/input-dimR.dat")
    do i = 1, 10
       read(11, *) initDimR(i)
    enddo
    close(11)
    
     open(12, file="./FORTRAN/input-dimAvg.dat")
     read(12, *) R1_avg
     close(12)
     
     open(13, file="./FORTRAN/input-dimMovAvg.dat")
     read(13, *) movAvgDiff
     close(13)
...
!    end if
    ...
    open(20, file="./FORTRAN/result-dimD.dat")
    open(21, file="./FORTRAN/result-dimR.dat")
    open(22, file="./FORTRAN/result-dimAvg.dat")
    ...
    do
        ...
        if (cnt == 10) then
            ...
            write(20, 130) dimValD(1), ",", dimValD(2), ",", dimValD(3), &
                        ",", dimValD(4), &
                        ",", dimValD(5), ",", dimValD(6), ",", dimValD(7), ",", dimValD(8), &
                        ",", dimValD(9), ",", dimValD(10)
                        
            write(21, 130) dimMeanR(1), ",", dimMeanR(2), ",", &
                         dimMeanR(3), ",", dimMeanR(4), ",", &
                         dimMeanR(5), ",", dimMeanR(6), ",", &
                         dimMeanR(7), ",", dimMeanR(8), ",", &
                         dimMeanR(9), ",", dimMeanR(10)
