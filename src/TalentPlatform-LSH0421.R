...
mapJpn = sf::st_read(file.path(globalVar$mapPath, "gadm36_JPN_shp/gadm36_JPN_1.shp"))
mapPrk = sf::st_read(file.path(globalVar$mapPath, "gadm36_PRK_shp/gadm36_PRK_1.shp"))
