...
# 요구사항
#================================================
# R을 이용한 일식 식분도 이미지 데이터 추출 및 평균 식분도 시각화 (식분도 8개)
...
fileInfo = Sys.glob(file.path(globalVar$inpPath, serviceName, "LSH0450_일식 식분도 이미지 데이터 추출.xlsx"))
...
# 평균식분도 결과 : "식분도8개 평균식분도" 폴더 참조
# 최대평균 : 0.671504507762135  
# 경주지점 : 0.624621476351862  

# 평균식분도 결과 : "식분도7개 평균식분도" 폴더 참조
# 최대평균 : 0.781717850453438   
# 경주지점 : 0.726761535978781   
...
#         mutate_cond(xAxis == posLon & yAxis >= posLat & yAxis <= posLat + 0.1, posVal = meanVal) %>%
